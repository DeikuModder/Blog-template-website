Hello there, here's my first template for a website, it's a portfolio, i made it so it'd be for general purposes, wich means it has nothing that you can relate to an specific workfiled.
